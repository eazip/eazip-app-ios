...
class Appointment {
    ...
    init(sewerFirstName: String, sewerLastName: String, sewerRating: Int, sewerBio: String, sewerStreet: String, sewerCity: String, day: Int, month: String, year: Int, hour: Int) {
